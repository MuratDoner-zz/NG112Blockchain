...
public class Ng112BlockchainApp {

    private static final Logger log = LoggerFactory.getLogger(Ng112BlockchainApp.class);

    private final Environment env;

    public Ng112BlockchainApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes NG112Blockchain.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(Ng112BlockchainApp.class);
